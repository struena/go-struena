...
import "github.com/struena/go-struena/accounts/abi"
...
import org.struena.struena.internal.*;
...
{{range $contract := .Contracts}}
	public class {{.Type}} {
		...
		{{if .InputBin}}
			...
			// deploy deploys a new Struena contract, binding an instance of {{.Type}} to it.
