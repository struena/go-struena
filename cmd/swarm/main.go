...
import (
	...
	"github.com/struena/go-struena/swarm"
	bzzapi "github.com/struena/go-struena/swarm/api"
	swarmmetrics "github.com/struena/go-struena/swarm/metrics"
...
// This init function sets defaults so cmd/swarm can run alongside struena.
func init() {
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.struena/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.struena/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.struena/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.struena/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
...
func bzzd(ctx *cli.Context) error {
	...
	//struena only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for struena and swarm
