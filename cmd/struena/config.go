...
func loadConfig(file string, cfg *struenaConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "struena.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, struenaConfig) {
	// Load defaults.
	cfg := struenaConfig{
