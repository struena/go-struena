...
import (
	...
	"github.com/struena/go-struena/common/fdlimit"
	"github.com/struena/go-struena/consensus"
	"github.com/struena/go-struena/consensus/clique"
	...
	"github.com/struena/go-struena/dashboard"
...
// for Struena and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `struena account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. struena account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// struena --keystore /tmp/mykeystore --lightkdf account new
//
