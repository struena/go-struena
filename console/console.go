...
import (
	...
	"github.com/struena/go-struena/internal/jsre"
	"github.com/struena/go-struena/internal/web3ext"
...
// Welcome show summary of current Struena instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Struena metadata
	fmt.Fprintf(c.printer, "Welcome to the Struena JavaScript console!\n\n")
	c.jsre.Run(`
