...
// NodeConfig represents the collection of configuration values to fine tune the Struena
...
// Node represents a Struena Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Struena node.
